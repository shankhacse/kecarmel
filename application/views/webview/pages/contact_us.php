        			...
        			<div class="col-md-6 col-sm-6 col-12 col-lg-4">
        				<div class="address location">
							...
							<div class="address__inner">
								...
								<ul>
									<li>Baruipur - Amtala Rd, P.O, Chandni<br> Bishnupur, West Bengal 743503 </li>
								</ul>
							</div>
        				</div>
        			</div>
        			...
        			<div class="col-md-6 col-sm-6 col-12 col-lg-4 xs-mt-60">
        				<div class="address phone">
							...
							<div class="address__inner">
								...
								<ul>
									<li><a href="tell:+033 2470 7957">033 2470 7957 </a></li>
									<li>&nbsp;</li>
								</ul>
							</div>
        				</div>
        			...
        			<div class="col-md-6 col-sm-6 col-12 col-lg-4 md-mt-60 sm-mt-60">
        				<div class="address email">
							...
							<div class="address__inner">
								...
								<ul>
									<li><a href="mailto:kecarmel@gmail.com">kecarmel@gmail.com</a></li>
                                    <li>&nbsp;</li>
        		...
        		<div class="row">
        			...
        			<div class="col-lg-5">
        				<div class="child__image">
        					<img src="<?php echo base_url();?>assets/images/others/4.jpg" alt="children images">
        				</div>
        			</div>
        		</div>
        	</div>
