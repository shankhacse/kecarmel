                                    ...
                                    <ul class="mainmenu">
                                        ...
                                        <li class="drop"><a href="<?php echo base_url();?>aboutus">About</a>
                                            ...
                                            <ul class="dropdown__menu">
                                                ...
                                                <li><a href="<?php echo base_url();?>aboutus/management">Management</a></li>
                                                <li><a href="<?php echo base_url();?>aboutus/school_group">School Groups</a></li>
                                        ...
                                        <li class="drop"><a href="<?php echo base_url();?>gallery">Gallery</a>
                                        ...
                                        <li class="drop"><a href="<?php echo base_url();?>kecsap">KECSAP</a></li>
