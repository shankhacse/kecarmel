						...
						<div class="col-md-8 col-lg-6 col-sm-9 col-12">
							<div class="jun__header__top__left">
								<ul class="top__address d-flex justify-content-start align-items-center flex-wrap flex-lg-nowrap flex-md-nowrap">
									...
									<li><span>Contact Now : </span><a href="#">033 2470 7957</a></li>
								</ul>
							</div>
						</div>
			...
			<div class="mainmenu__wrapper bg--white sticky__header">
				<div class="container">
					<div class="row d-none d-lg-flex">
						<div class="col-sm-4 col-md-6 col-lg-6 order-1 order-lg-1">
							<div class="logo">
								...
								<div class="schoolname" style="width:100%;">
										<h2 class="kecarmel_title">K. E. CARMEL</h2>
										<h2 class="kecarmel_head">SCHOOL , AMTALA</h2>
						...
						<div class="col-sm-4 col-md-2 col-lg-6 order-3 order-lg-2">
							<div class="mainmenu__wrap">
								<nav class="mainmenu__nav">
                                    <ul class="mainmenu">
                                        ...
                                        <li class="drop"><a href="javascript:;">About</a>
                                            <ul class="dropdown__menu">
                                                <li><a href="javascript:;">Our History</a></li>
                                                <li><a href="javascript:;">Mission & Moto</a></li>
                                                <li><a href="javascript:;">General & Specific Norms</a></li>
                    ...
                    <div class="mobile-menu d-block d-lg-none">
                    	<div class="logo">
                    		<a href="index.html"><img src="<?php echo base_url();?>assets/images/logo/kecarmel_logo.png" alt="logo images" /></a>
                    	</div>
                    	<!-- 
                    	<a class="minicart-trigger" href="#">
                    		<i class="fa fa-shopping-basket"></i>
							...
							<div class="footer__contact__wrapper d-flex flex-wrap justify-content-between">
								<div class="single__footer__address">
									...
									<div class="ft__contact__details">
										<p>Baruipur - Amtala Rd, P.O, Chandni</p>
										<p>Bishnupur, West Bengal 743503 </p>
									</div>
								</div>
								<div class="single__footer__address">
									<div class="ft__contact__icon">
					...
					<div class="row align-items-center copyright__wrapper justify-content-center">
						<div class="col-lg-12 col-sm-12 col-md-12">
							<div class="coppy__right__inner text-center">
								<p><i class="fa fa-copyright"></i>All Right Reserved.<a href="#"> KE Carmel Amtala School</a></p>
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="cartbox__inner text-left">
                    <div class="cartbox__items">
                        ...
                        <div class="cartbox__item">
                            <div class="cartbox__item__thumb">
                                <a href="shop-single.html">
                                    <img src="<?php echo base_url();?>assets/images/product/sm-pro/1.jpg" alt="small thumbnail">
                                </a>
                            </div>
                        ...
                        <div class="cartbox__item">
                            <div class="cartbox__item__thumb">
                                <a href="shop-single.html">
                                    <img src="<?php echo base_url();?>assets/images/product/sm-pro/2.jpg" alt="small thumbnail">
                                </a>
                            </div>
                            <div class="cartbox__item__content">
                        ...
                        <div class="cartbox__item">
                            <div class="cartbox__item__thumb">
                                <a href="shop-single.html">
                                    <img src="<?php echo base_url();?>assets/images/product/sm-pro/3.jpg" alt="small thumbnail">
                                </a>
                            </div>
                            <div class="cartbox__item__content">
